...
var connectionString = "Host=localhost;Database=wtm_log2023;Username=postgres;Password=postgres;Port=5432";
...
var connectionString2 = "Host=localhost;Database=wtm_log2024;Username=postgres;Password=postgres;Port=5432";
if (!builder.Environment.IsDevelopment())
{
    var DB_HOST = Environment.GetEnvironmentVariable("DB_HOST");
    var DB_PORT = Environment.GetEnvironmentVariable("DB_PORT");
